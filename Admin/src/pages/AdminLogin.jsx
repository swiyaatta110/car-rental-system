...
import { loginAdmin } from "../services/getServices.js";
import { toast, ToastContainer } from "react-toastify";
import { Link, useNavigate } from "react-router";
import { useDispatch } from "react-redux";
import { loginAdmin as loginAdminAction } from "../features/adminSlice.js";
...
const AdminLogin = () => {
  ...
  const submitHandler = async (e) => {
    ...
    let data = await loginAdmin(form);
    console.log(data);
    
    if (data.suc) {
      toast.success(data.msg);
      dispatch(loginAdminAction(data.admin));
